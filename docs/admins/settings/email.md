...
!!! info "Hinweis"
    E-mails werden zurzeit für Benachrichtigungen zu Projekten und für den E-Mail-Digest verwendet. Weitere Benachrichtigungen werden in zukünftigen Versionen folgen.
...
![mail_digest](screenshots/mail_digest.png)
///caption
...
Die Nutzenden erhalten in der von ihnen gewählten Regelmäßigkeit eine Mail mit Aktivitäts-Hinweisen, ungelesenen Nachrichten und ob OSIRIS aktualisiert wurde. 
