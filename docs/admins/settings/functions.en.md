...
In the admin area, under Settings &#8594 Features, you can manage the variety of optional features in OSIRIS and either activate or deactivate them. The features are displayed in the menu on the left accordingly. Please note that no rights are assigned to these features by default. You must assign these accordingly in the admin area under &#8594 Roles and Rights.

Here you will find a list of all available features:

## Core Features

??? note "[OSIRIS Portfolio](https://wiki.osiris-app.de/en/topics/portfolio/)"
...
??? note "[Projects&Proposals](https://wiki.osiris-app.de/en/admins/content/projects/)"
    OSIRIS can manage complete project life cycles, from proposal submission to project reporting. By activating this function, you can create and manage projects and proposals within OSIRIS. It is possible to define your own project types and manage data fields.

??? note "[Nagoya Protocol Compliance](https://wiki.osiris-app.de/en/topics/nagoya/)"
...
??? note "[Teaching modules](https://wiki.osiris-app.de/en/users/courses/)"
...
??? note "[Research Topics](https://wiki.osiris-app.de/en/users/topics/)"
...
??? note "[Infrastructures](https://wiki.osiris-app.de/en/users/infrastructures/)"
...
??? note "[Events](https://wiki.osiris-app.de/en/users/events/)"
...
??? note "[Tags](https://wiki.osiris-app.de/en/admins/content/keywords/)"
...
??? note "[Research Trips](https://wiki.osiris-app.de/en/admins/travel/)"
...
??? note "[Quarterly reporting](https://wiki.osiris-app.de/en/users/reporting/quarterly-reporting/)"
...
??? note "[Quality workflows](https://wiki.osiris-app.de/en/admins/workflows/workflows/)"
