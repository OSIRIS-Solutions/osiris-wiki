...
Forschungsbereiche können in OSIRIS dazu verwendet werden, thematische Schwerpunkte wissenschaftlicher Forschung von Forschenden oder Forschungsgruppen zu definieren. Die Funktion muss von eurer Administration unter Einstellungen &#8594 Funktionen aktiviert werden.
...
![Forschungsbereich erstellen](screenshots_topics/Neuer%20Forschungsbereich.png)
///caption
...
![Forschungsbereich Seite](screenshots_topics/topic_page.png)
///caption
...
![Forschungsbereiche verknüpfen](screenshots_topics/forschungsbereich_hinzufügen.png)
///caption
...
Um eine **Person** mit einem Forschungsbereich zu verknüpfen, gehst du auf das Profil &#8594 Profil bearbeiten &#8594 Forschung. Hier kannst du die Bereiche anklicken, die mit dieser Person verknüpft werden sollen. Nachdem du gespeichert hast, werden die ausgewählten Bereiche auf dem Profil durch einen Button angezeigt, der direkt zum Forschungsbereich führt.

![Profil mit Forschungsbereich](screenshots_topics/bereich_anzeige_profil.png)
///caption
...
![Verknüpfung Orga](screenshots_topics/Anzeige_orgaeinheiten.png)
///caption
