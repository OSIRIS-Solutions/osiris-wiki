...
Um eine individuellere Auflistung der Einträge zu erstellen, kannst du die [erweiterte Suche](/users/activities/advanced-search/) nutzen.  

Neben jeder Aktivität findest du einen Pfeil, der dich zur [erweiterten Ansicht](/users/activities/expanded_view/) des Eintrags führt. Wenn du ohne die erweiterte Suche eine Liste an Einträgen zum Exportieren erstellen möchtest, kannst du das Symbol des [Einkaufswagens](/users/activities/cart/) rechts neben dem Pfeil nutzen.  

Oben links siehst du den Button, der dich zu den [Statistiken](/users/reporting/statistics/) führt. Hier kannst du verschiedene Tabellen zu den Einträgen in einem bestimmten Reportzeitraum in OSIRIS finden.  
